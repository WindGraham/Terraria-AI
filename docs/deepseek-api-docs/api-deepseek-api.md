...
-   [English](/api/deepseek-api){.dropdown__link target="_self"
    rel="noopener noreferrer" lang="en"}
-   [中文（中国）](/zh-cn/api/deepseek-api){.dropdown__link
...
-   ::: menu__list-item-collapsible
    ...
    -   [基本信息](/zh-cn/api/deepseek-api){.menu__link
        .menu__link--active aria-current="page" tabindex="0"}

    -   ::: menu__list-item-collapsible
        [对话（Chat）](/zh-cn/api/create-chat-completion){.menu__link
        .menu__link--sublist .menu__link--sublist-caret
        aria-expanded="false" tabindex="0"}
        :::

    -   ::: menu__list-item-collapsible
        [补全（Completions）](/zh-cn/api/create-completion){.menu__link
        .menu__link--sublist .menu__link--sublist-caret
        aria-expanded="false" tabindex="0"}
        :::

    -   ::: menu__list-item-collapsible
        [模型（Model）](/zh-cn/api/list-models){.menu__link
        .menu__link--sublist .menu__link--sublist-caret
        aria-expanded="false" tabindex="0"}
        :::

    -   ::: menu__list-item-collapsible
        [其它](/zh-cn/api/get-user-balance){.menu__link
        .menu__link--sublist .menu__link--sublist-caret
        aria-expanded="false" tabindex="0"}
        :::
...
-   [![](data:image/svg+xml;base64,){.breadcrumbHomeIcon_fbmM}](/zh-cn/){.breadcrumbs__link
    aria-label="主页面"}
-   [API 文档]{.breadcrumbs__link}
-   [基本信息]{.breadcrumbs__link itemprop="name"}

::: {.theme-doc-markdown .markdown}
::: row
::: {.col .col--12}
[Version: 1.0.0]{.theme-doc-version-badge .badge .badge--secondary}

# Deepseek API {#deepseek-api .openapi__heading}

使用 DeepSeek API 之前，请先 [创建 API
密钥](https://platform.deepseek.com/api_keys){target="_blank"
rel="noopener noreferrer"}。

::: {style="margin-bottom:2rem"}
## Authentication[​](#authentication "Authentication的直接链接"){.hash-link aria-label="Authentication的直接链接"} {#authentication .anchor .anchorWithStickyNavbar_YAqC .openapi-tabs__heading}

::: openapi-tabs__schema-container
::: openapi-tabs__schema-tabs-container
-   [HTTP: Bearer Auth]{.openapi-tabs__schema-label}
:::
...
::: {style="display:flex;flex-direction:column;margin-bottom:var(--ifm-paragraph-margin-bottom)"}
###  {#section style="margin-bottom:0.25rem"}

Contact

DeepSeek 技术支持:
[api-service@deepseek.com](mailto:api-service@deepseek.com){target="_blank"
rel="noopener noreferrer"}
:::

::: {style="margin-bottom:var(--ifm-paragraph-margin-bottom)"}
###  {#section-1 style="margin-bottom:0.25rem"}

Terms of Service

[](https://cdn.deepseek.com/policies/zh-CN/deepseek-open-platform-terms-of-service.html)

[https://cdn.deepseek.com/policies/zh-CN/deepseek-open-platform-terms-of-service.html](https://cdn.deepseek.com/policies/zh-CN/deepseek-open-platform-terms-of-service.html){target="_blank"
rel="noopener noreferrer"}
:::

::: {style="margin-bottom:var(--ifm-paragraph-margin-bottom)"}
###  {#section-2 style="margin-bottom:0.25rem"}
...
::: {.col .col--12}
[](/zh-cn/news/news0725){.pagination-nav__link
...
[](/zh-cn/api/create-chat-completion){.pagination-nav__link
