...
-   [English](/quick_start/error_codes){.dropdown__link target="_self"
    rel="noopener noreferrer" lang="en"}
-   [中文（中国）](/zh-cn/quick_start/error_codes){.dropdown__link
...
-   [错误码]{.breadcrumbs__link itemprop="name"}
...
您在调用 DeepSeek API
时，可能会遇到以下错误。这里列出了相关错误的原因及其解决方法。
  ...
  401 - 认证失败                      **原因**：API key 错误，认证失败\
                                      **解决方法**：请检查您的 API key 是否正确，如没有 API key，请先
                                      [创建 API
                                      key](https://platform.deepseek.com/api_keys){target="_blank"
                                      rel="noopener noreferrer"}

  402 - 余额不足                      **原因**：账号余额不足\
                                      **解决方法**：请确认账户余额，并前往
                                      [充值](https://platform.deepseek.com//top_up){target="_blank"
                                      rel="noopener noreferrer"} 页面进行充值
...
[](/zh-cn/news/news251201){.pagination-nav__link
