...
-   [English](/quick_start/parameter_settings){.dropdown__link
    target="_self" rel="noopener noreferrer" lang="en"}
-   [中文（中国）](/zh-cn/quick_start/parameter_settings){.dropdown__link
...
-   [Temperature 设置]{.breadcrumbs__link itemprop="name"}
...
[](/zh-cn/quick_start/token_usage){.pagination-nav__link
