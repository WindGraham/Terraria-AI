...
-   [English](/guides/multi_round_chat){.dropdown__link target="_self"
    rel="noopener noreferrer" lang="en"}
-   [中文（中国）](/zh-cn/guides/multi_round_chat){.dropdown__link
...
-   [多轮对话]{.breadcrumbs__link itemprop="name"}
...
API，即服务端不记录用户请求的上下文，用户在每次请求时，**需将之前所有对话历史拼接好后**，传递给对话
API。
...
::: {.col .col--12}
[](/zh-cn/guides/thinking_mode){.pagination-nav__link
