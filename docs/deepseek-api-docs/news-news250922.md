...
-   [English](/news/news250922){.dropdown__link target="_self"
    rel="noopener noreferrer" lang="en"}
-   [中文（中国）](/zh-cn/news/news250922){.dropdown__link
...
-   ::: menu__list-item-collapsible
    ...
    -   [DeepSeek V3.1 更新
        2025/09/22](/zh-cn/news/news250922){.menu__link
...
-   [![](data:image/svg+xml;base64,){.breadcrumbHomeIcon_fbmM}](/zh-cn/){.breadcrumbs__link
    aria-label="主页面"}
-   [新闻]{.breadcrumbs__link}
-   [DeepSeek V3.1 更新 2025/09/22]{.breadcrumbs__link itemprop="name"}
...
的输出效果相比前一版本更加稳定，新模型各领域测评结果如下：

![](/zh-cn/img/deepseek_v3.1_terminus_benchmark_cn.webp){width="512"}

目前，官方 App、网页端、小程序与 DeepSeek API 模型**均已同步更新为
DeepSeek-V3.1-Terminus。**

开源版本下载地址如下：

-   **Hugging Face：**
    [https://huggingface.co/deepseek-ai/DeepSeek-V3.1-Terminus](https://huggingface.co/deepseek-ai/DeepSeek-V3.1-Terminus){target="_blank"
    rel="noopener noreferrer"}
-   **ModelScope：**
    [https://modelscope.cn/models/deepseek-ai/DeepSeek-V3.1-Terminus](https://modelscope.cn/models/deepseek-ai/DeepSeek-V3.1-Terminus){target="_blank"
    rel="noopener noreferrer"}

感谢并欢迎广大用户积极反馈在使用 DeepSeek
模型过程中遇到的各类问题，我们将持续迭代提升模型性能，优化用户使用体验。
:::
:::
:::
...
::: {.col .col--12}
[](/zh-cn/news/news250929){.pagination-nav__link
...
[](/zh-cn/news/news250821){.pagination-nav__link
