::: {#__docusaurus}
::: {role="region" aria-label="跳到主要内容"}
[跳到主要内容](#__docusaurus_skipToContent_fallback){.skipToContent_xSgN}
:::
...
.themedComponent--light_FDat}![DeepSeek API 文档
Logo](https://cdn.deepseek.com/platform/favicon.png){.themedComponent_EBr5
...
-   ::: menu__list-item-collapsible
    [快速开始](/zh-cn/){.menu__link .menu__link--sublist
    .menu__link--sublist-caret aria-expanded="true"}
    :::

    -   [首次调用 API](/zh-cn/){.menu__link tabindex="0"}
    -   [模型 & 价格](/zh-cn/quick_start/pricing){.menu__link
        tabindex="0"}
    -   [Temperature
        设置](/zh-cn/quick_start/parameter_settings){.menu__link
        tabindex="0"}
    -   [Token 用量计算](/zh-cn/quick_start/token_usage){.menu__link
        tabindex="0"}
    -   [限速](/zh-cn/quick_start/rate_limit){.menu__link tabindex="0"}
    -   [错误码](/zh-cn/quick_start/error_codes){.menu__link
        tabindex="0"}

-   ::: menu__list-item-collapsible
    [新闻](/zh-cn/news/news251201){.menu__link .menu__link--sublist
    .menu__link--sublist-caret aria-expanded="true"}
    :::

    -   [DeepSeek-V3.2 正式版发布
        2025/12/01](/zh-cn/news/news251201){.menu__link tabindex="0"}
    -   [DeepSeek-V3.2-Exp 发布
        2025/09/29](/zh-cn/news/news250929){.menu__link tabindex="0"}
    -   [DeepSeek V3.1 更新
        2025/09/22](/zh-cn/news/news250922){.menu__link tabindex="0"}
    -   [DeepSeek V3.1 发布
        2025/08/21](/zh-cn/news/news250821){.menu__link tabindex="0"}
    -   [DeepSeek-R1-0528 发布
        2025/05/28](/zh-cn/news/news250528){.menu__link tabindex="0"}
    -   [DeepSeek-V3-0324 发布
        2025/03/25](/zh-cn/news/news250325){.menu__link tabindex="0"}
    -   [DeepSeek-R1 发布
        2025/01/20](/zh-cn/news/news250120){.menu__link tabindex="0"}
    -   [DeepSeek APP 发布
        2025/01/15](/zh-cn/news/news250115){.menu__link tabindex="0"}
    -   [DeepSeek-V3 发布 2024/12/26](/zh-cn/news/news1226){.menu__link
        tabindex="0"}
    -   [DeepSeek-V2.5-1210 发布
        2024/12/10](/zh-cn/news/news1210){.menu__link tabindex="0"}
    -   [DeepSeek-R1-Lite 发布
        2024/11/20](/zh-cn/news/news1120){.menu__link tabindex="0"}
    -   [DeepSeek-V2.5 发布
        2024/09/05](/zh-cn/news/news0905){.menu__link tabindex="0"}
    -   [API 上线硬盘缓存 2024/08/02](/zh-cn/news/news0802){.menu__link
        tabindex="0"}
    -   [API 升级新功能 2024/07/25](/zh-cn/news/news0725){.menu__link
        tabindex="0"}

-   ::: menu__list-item-collapsible
    [API 文档](/zh-cn/api/deepseek-api){.menu__link .menu__link--sublist
    .menu__link--sublist-caret aria-expanded="false"}
    :::

-   ::: menu__list-item-collapsible
    [API 指南](/zh-cn/guides/thinking_mode){.menu__link
    .menu__link--sublist .menu__link--sublist-caret .menu__link--active
    aria-expanded="true"}
    :::

    -   [思考模式](/zh-cn/guides/thinking_mode){.menu__link
        tabindex="0"}
    -   [多轮对话](/zh-cn/guides/multi_round_chat){.menu__link
        tabindex="0"}
    -   [对话前缀续写（Beta）](/zh-cn/guides/chat_prefix_completion){.menu__link
        tabindex="0"}
    -   [FIM 补全（Beta）](/zh-cn/guides/fim_completion){.menu__link
        tabindex="0"}
    -   [JSON Output](/zh-cn/guides/json_mode){.menu__link tabindex="0"}
    -   [Tool Calls](/zh-cn/guides/tool_calls){.menu__link
        .menu__link--active aria-current="page" tabindex="0"}
    -   [上下文硬盘缓存](/zh-cn/guides/kv_cache){.menu__link
        tabindex="0"}
    -   [Anthropic API](/zh-cn/guides/anthropic_api){.menu__link
        tabindex="0"}

-   ::: menu__list-item-collapsible
    [其它资源](https://github.com/deepseek-ai/awesome-deepseek-integration/tree/main){.menu__link
    .menu__link--sublist .menu__link--sublist-caret target="_blank"
    rel="noopener noreferrer" aria-expanded="true"}
    :::

    -   [实用集成![](data:image/svg+xml;base64,){.iconExternalLink_YH95}](https://github.com/deepseek-ai/awesome-deepseek-integration/tree/main){.menu__link
        .menuExternalLink_kqFC target="_blank" rel="noopener noreferrer"
        tabindex="0"}
    -   [API
        服务状态![](data:image/svg+xml;base64,){.iconExternalLink_YH95}](https://status.deepseek.com/){.menu__link
        .menuExternalLink_kqFC target="_blank" rel="noopener noreferrer"
        tabindex="0"}

-   [常见问题](/zh-cn/faq){.menu__link}

-   [更新日志](/zh-cn/updates){.menu__link}
:::
:::
...
## 非思考模式[​](#非思考模式 "非思考模式的直接链接"){.hash-link aria-label="非思考模式的直接链接"} {#非思考模式 .anchor .anchorWithStickyNavbar_YAqC}

### 样例代码[​](#样例代码 "样例代码的直接链接"){.hash-link aria-label="样例代码的直接链接"} {#样例代码 .anchor .anchorWithStickyNavbar_YAqC}

这里以获取用户当前位置的天气信息为例，展示了使用 Tool Calls 的完整
Python 代码。

Tool Calls 的具体 API
格式请参考[对话补全](/zh-cn/api/create-chat-completion/)文档。
...
3.  用户：调用 function
    `get_weather({location: 'Hangzhou'})`，并传给模型。
...
## 思考模式[​](#思考模式 "思考模式的直接链接"){.hash-link aria-label="思考模式的直接链接"} {#思考模式 .anchor .anchorWithStickyNavbar_YAqC}

从 DeepSeek-V3.2 开始，API
支持了思考模式下的工具调用能力，详见[思考模式](/zh-cn/guides/thinking_mode#%E5%B7%A5%E5%85%B7%E8%B0%83%E7%94%A8)。

------------------------------------------------------------------------

## `strict` 模式（Beta）[​](#strict-模式beta "strict-模式beta的直接链接"){.hash-link aria-label="strict-模式beta的直接链接"} {#strict-模式beta .anchor .anchorWithStickyNavbar_YAqC}

在 `strict` 模式下，模型在输出 Function 调用时会严格遵循 Function 的
JSON Schema 的格式要求，以确保模型输出的 Function
符合用户的定义。在思考与非思考模式下的工具调用，均可使用 `strict` 模式。

要使用 `strict` 模式，需要：

1.  用户需要设置 `base_url="https://api.deepseek.com/beta"` 来开启 Beta
    功能
2.  在传入的 `tools` 列表中，所有 `function` 均需设置 `strict` 属性为
    `true`
3.  服务端会对用户传入的 Function 的 JSON Schema
    进行  校验，如不符合规范，或遇到服务端不支持的 JSON Schema
    类型，将返回错误信息

以下是 `strict` 模式下 tool 的定义样例：

::: {.language-json .codeBlockContainer_pGXX .theme-code-block style="--prism-color:#393A34;--prism-background-color:#f6f8fa"}
::: codeBlockContent_CRIs
``` {.prism-code .language-json .codeBlock_JcNi .thin-scrollbar tabindex="0" style="color:#393A34;background-color:#f6f8fa"}
{
    "type": "function",
    "function": {
        "name": "get_weather",
...
### `strict` 模式支持的 JSON Schema 类型[​](#strict-模式支持的-json-schema-类型 "strict-模式支持的-json-schema-类型的直接链接"){.hash-link aria-label="strict-模式支持的-json-schema-类型的直接链接"} {#strict-模式支持的-json-schema-类型 .anchor .anchorWithStickyNavbar_YAqC}
...
#### object 类型[​](#object-类型 "object 类型的直接链接"){.hash-link aria-label="object 类型的直接链接"} {#object-类型 .anchor .anchorWithStickyNavbar_YAqC}
...
#### string 类型[​](#string-类型 "string 类型的直接链接"){.hash-link aria-label="string 类型的直接链接"} {#string-类型 .anchor .anchorWithStickyNavbar_YAqC}
...
#### number/integer 类型[​](#numberinteger-类型 "number/integer 类型的直接链接"){.hash-link aria-label="number/integer 类型的直接链接"} {#numberinteger-类型 .anchor .anchorWithStickyNavbar_YAqC}
...
#### array 类型[​](#array-类型 "array 类型的直接链接"){.hash-link aria-label="array 类型的直接链接"} {#array-类型 .anchor .anchorWithStickyNavbar_YAqC}
...
#### enum[​](#enum "enum的直接链接"){.hash-link aria-label="enum的直接链接"} {#enum .anchor .anchorWithStickyNavbar_YAqC}

enum
可以确保输出是预期的几个选项之一，例如在订单状态的场景下，只能是有限几个状态之一。
...
#### anyOf[​](#anyof "anyOf的直接链接"){.hash-link aria-label="anyOf的直接链接"} {#anyof .anchor .anchorWithStickyNavbar_YAqC}

匹配所提供的多个 schema
中的任意一个，可以处理可能具有多种有效格式的字段，例如用户的账户可能是邮箱或者手机号中的一个：
...
#### \$ref 和 \$def[​](#ref-和-def "$ref 和 $def的直接链接"){.hash-link aria-label="$ref 和 $def的直接链接"} {#ref-和-def .anchor .anchorWithStickyNavbar_YAqC}

可以使用 \$def 定义模块，再用 \$ref
引用以减少模式的重复和模块化，此外还可以单独使用 \$ref 定义递归结构。
...
::: {.col .col--12}
[](/zh-cn/guides/json_mode){.pagination-nav__link
...
[](/zh-cn/guides/kv_cache){.pagination-nav__link
...
-   [非思考模式](#非思考模式){.table-of-contents__link .toc-highlight}
    -   [样例代码](#样例代码){.table-of-contents__link .toc-highlight}
-   [思考模式](#思考模式){.table-of-contents__link .toc-highlight}
-   [`strict` 模式（Beta）](#strict-模式beta){.table-of-contents__link
    .toc-highlight}
    -   [`strict` 模式支持的 JSON Schema
        类型](#strict-模式支持的-json-schema-类型){.table-of-contents__link
        .toc-highlight}
:::
:::
:::
