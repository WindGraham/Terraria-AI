...
-   [English](/quick_start/pricing){.dropdown__link target="_self"
    rel="noopener noreferrer" lang="en"}
-   [中文（中国）](/zh-cn/quick_start/pricing){.dropdown__link
...
-   [模型 & 价格]{.breadcrumbs__link itemprop="name"}
...
下表所列模型价格以"百万 tokens"为单位。Token
是模型用来表示自然语言文本的的最小单位，可以是一个词、一个数字或一个标点符号等。我们将根据模型输入和输出的总
token 数进行计量计费。

------------------------------------------------------------------------

## 模型细节[​](#模型细节 "模型细节的直接链接"){.hash-link aria-label="模型细节的直接链接"} {#模型细节 .anchor .anchorWithStickyNavbar_YAqC}
...
::: {style="font-size:14px"}
  ...
  ----------------- -------------------------------------------------------------- ---------------------------------------------------------------------- -------------------
      ...
      BASE URL                                                                     [https://api.deepseek.com](https://api.deepseek.com){target="_blank"   
                                                                                   rel="noopener noreferrer"}                                             

      模型版本                                                                     DeepSeek-V3.2\                                                         DeepSeek-V3.2\
                                                                                   （非思考模式）                                                         （思考模式）
...
## 扣费规则[​](#扣费规则 "扣费规则的直接链接"){.hash-link aria-label="扣费规则的直接链接"} {#扣费规则 .anchor .anchorWithStickyNavbar_YAqC}

扣减费用 = token 消耗量 ×
模型单价，对应的费用将直接从充值余额或赠送余额中进行扣减。
当充值余额与赠送余额同时存在时，优先扣减赠送余额。

产品价格可能发生变动，DeepSeek
保留修改价格的权利。请您依据实际用量按需充值，定期查看此页面以获知最新价格信息。
:::
:::
:::
...
::: {.col .col--12}
[](/zh-cn/){.pagination-nav__link .pagination-nav__link--prev}
...
[](/zh-cn/quick_start/parameter_settings){.pagination-nav__link
...
-   [模型细节](#模型细节){.table-of-contents__link .toc-highlight}
-   [扣费规则](#扣费规则){.table-of-contents__link .toc-highlight}
:::
:::
:::
:::
